...
public enum ErrorCode {
    ...
    INVALID_EMAIL_TITLE_VALUE(HttpStatus.BAD_REQUEST, false, 1102, "유효하지 않은 이메일 제목 정보입니다."),
    INVALID_PASSWORD_LENGTH(HttpStatus.BAD_REQUEST, false, 1103, "비밀번호는 8자 이상 20자 이하로 입력해주세요.")
    ;
